...
function nodeOp 
{
	scp -r -o BatchMode=yes -o ConnectTimeout=5 princeton_oscar@$1:entry.csv $ENTRY_DIRNAME/$1.csv 2> /dev/null 
  	scp -r -o BatchMode=yes -o ConnectTimeout=5 princeton_oscar@$1:exit.csv $EXIT_DIRNAME/$1.csv 2> /dev/null 
  	scp -r -o BatchMode=yes -o ConnectTimeout=5 princeton_oscar@$1:entryExit.csv $ENTRYEXIT_DIRNAME/$1.csv 2> /dev/null 
