...
function nodeOp 
{
	scp -r -o BatchMode=yes -o ConnectTimeout=5 -r princeton_oscar@$1:entryResults $ENTRY_DIRNAME/$1 2> /dev/null 
  	scp -r -o BatchMode=yes -o ConnectTimeout=5 -r princeton_oscar@$1:exitResults $EXIT_DIRNAME/$1 2> /dev/null 
  	scp -r -o BatchMode=yes -o ConnectTimeout=5 -r princeton_oscar@$1:entryExitResults $ENTRYEXIT_DIRNAME/$1 2> /dev/null 
